                   ...
                   <?php    endwhile; 
                         ...
                         <?php 
                             if( have_rows('computation') ) :
                                      ...
                                      $h_color = get_sub_field('highlight_color');
                                    ...
                                    <td><span class="amount amount-md <?php echo ($h_color == 1) ? 'text-dominant' : ''; ?>"><?php echo get_sub_field('gold_value') ?> </span></td>
                                    <td class="no-bg custom-text"><span class="<?php echo ($h_color == 1) ? 'text-dominant' : ''; ?>"><?php echo get_sub_field('platinum_pricing') ?></span></td>
                                    <?php
                                         echo '</tr>';
                                       endwhile;
